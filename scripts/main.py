...
if __name__ == '__main__':
    ...
    parser.add_argument('--iter', default=3000, type=int, help='iterations for the model')
    parser.add_argument('--warmup-iter', default=1500, type=int, help='warmup iterations for the model')
